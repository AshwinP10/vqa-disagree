...
\title{\dname{}: Multi-Model Disagreement as an\\Annotation-Free Difficulty Signal for VQA Benchmarks}

%%%%%%%%% AUTHORS
% In [review] mode (the current setting), this \author block is automatically
% hidden by cvpr.sty and replaced with "Anonymous CVPR submission / Paper ID *****".
% Switch the \usepackage line above to \usepackage{cvpr} for the camera-ready
% copy and the real author block below will appear.
